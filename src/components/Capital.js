...
useEffect(()=>{
  let { totalCapital, totalInterestAmount }=summary.reduce((acc,s)=>{
...
console.log(totalCollection)
  ...
  <div style={{backgroundColor:"#FFFDB5",color:'#01204E',height:"100vh"}}>
    ...
    <div style={{textAlign:"center",marginTop:50}}>
        <button style={{backgroundColor:"#9BEC00",width:300,height:80,fontSize:35,marginBottom:20}} onClick={handleSubmit}>SUBMIT</button>
      </div>
   <hr/>
  
  <div style={{marginTop:60,marginTop:100,fontSize:50}}>Total Capital Amount:&nbsp;&nbsp;&nbsp;&nbsp;<span style={{fontWeight:600}}>{totalCapital}</span></div>
  <div style={{marginTop:30,fontSize:50}}>Total Interest Amount:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style={{fontWeight:600}}>{totalInterestAmount}</span></div>
  <div style={{marginTop:30,fontSize:50,marginLeft:136}}>Total Collection:&nbsp;&nbsp;&nbsp;&nbsp;<span style={{fontWeight:600}}>{totalCollection}</span></div>
  </div>
    </>
}
