...
<div style={{display:"flex"}}>
 <div className="card shadow ms-5" style={{width: "100rem"}}>
  ...
  <div className="card-body">
    <h3 className="card-title text-center mt-1 mb-4">Customer EMI Details</h3>
  ...
  <h5 className="card-title text-center mt-2">Loan Amount:{loanAmount}</h5>
    ...
    <h5 className="card-title text-center mt-2">Actual EMI Amount:{emiAmount}</h5> 
  ...
  <div>
  <div className="card mt-5 " style={{width: "100rem",marginLeft:50,backgroundColor:"red",color:"white"}}>
  ...
  <div className="card-body">
    ...
    <label style={{fontSize:25,marginLeft:50}}>ModeOfPayment:</label>
    <input type='text'onChange={(e)=>setModeOfPayment(e.target.value)}/>
