...
function CustomerEdit() {
  ...
  const submitUserData = async (e) => {
    ...
    if (name === "") {
      ...
      try {
        let res = await axios.put(`${url}/customer-edit/${id}`, {
          name,
          email,
          adharNumber,
          mobileNumber,
          ...
          <Row>
            ...
            <Form.Group className="mb-3 col-lg-4" controlId="formBasicEmail">
              ...
              <Form.Control
                ...
                value={inputdata.uploaddocuments}
                onChange={setInputValue}
              />
            </Form.Group>
            ...
            <Form.Group
              ...
              controlId="formBasicadharNumber"
            >
              <Form.Label>adharNumber</Form.Label>
              <Form.Control
                type="number"
                name="adharNumber"
                value={inputdata.adharNumber}
                onChange={setInputValue}
              />
            </Form.Group>
            <Form.Group
            ...
            <Form.Group
              className="mb-3 col-lg-4"
              controlId="formBasicalternativemobileNumber"
            >
              <Form.Label>Alternative Number</Form.Label>
              <Form.Control
                type="number"
                name="alternativeNumber"
                value={inputdata.alternativeNumber}
                onChange={setInputValue}
              />
            </Form.Group>
            ...
            <Form.Group
              className="mb-3 col-lg-4"
              controlId="formBasicResidentialAddress"
            >
            ...
            <Form.Group
              className="mb-3 col-lg-4"
              controlId="formBasicofficeAddress"
            >
